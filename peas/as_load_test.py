...
def test_thread_function(server, domain, singleuser, password, index, begin, end, sleep, period):
...
def test_main(args):
    ...
    for i in range(0, accounts):
        ...
        threads.append(threading.Thread(target=test_thread_function,
                                        args=(server, domain, singleuser, password, i, begin, end, delay, period)))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--delay', default=0.1,
                        help='the delay (in seconds) between each requests in a thread, default value: 0.1 (seconds)',
                        type=float)
    ...
    parser.add_argument('--user', help='username for single test, optional')
    ...
    parser.add_argument('--log', default="activesync_test.log",
                        help='error log file name, default name: activesync_test.log')
